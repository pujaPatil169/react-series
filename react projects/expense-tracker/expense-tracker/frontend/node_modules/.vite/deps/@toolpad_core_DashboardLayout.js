...
import {
  ...
  isPageItemSelected
} from "./chunk-5HOV6HHH.js";
import "./chunk-NLN4UES3.js";
import "./chunk-OSHVBEDD.js";
import {
  BrandingContext,
  NavigationContext,
  PaletteModeContext,
...
} from "./chunk-LAX2FDCD.js";
import {
  Divider_default,
  List_default,
  Popover_default
} from "./chunk-WLOX5SL6.js";
import "./chunk-G73U6KOJ.js";
import "./chunk-P67GKQQB.js";
import "./chunk-W5TZAFQA.js";
import "./chunk-FIGWBPCB.js";
import "./chunk-JNTNOSWU.js";
import "./chunk-QKYP2CJX.js";
import "./chunk-3HPN5KNE.js";
import {
  Stack_default
} from "./chunk-H7BOXYU2.js";
import {
  Box_default
} from "./chunk-EXLTUO2E.js";
import "./chunk-SPZGUCPH.js";
import {
  Button_default
} from "./chunk-RPVW3PQG.js";
import "./chunk-TF22AXAI.js";
import "./chunk-NGSO45VV.js";
import "./chunk-EYAAS2SK.js";
import "./chunk-3QCBDWTU.js";
import "./chunk-VY5NFQXH.js";
import "./chunk-SRIJHJKX.js";
import {
  ExpandMore_default
} from "./chunk-QXTMVKAT.js";
import {
  MoreVert_default
} from "./chunk-CIYTZ4ZL.js";
import "./chunk-UK4IUEG6.js";
import {
  Typography_default
} from "./chunk-QA377DXA.js";
import {
  Collapse_default
} from "./chunk-QVSB4Q3C.js";
import "./chunk-ZOKU5DI5.js";
import {
  Avatar_default
} from "./chunk-UVZQ7A3R.js";
import "./chunk-TILSR7H6.js";
import {
  IconButton_default
} from "./chunk-RJPWSLUO.js";
import "./chunk-ZCIGBSY4.js";
import "./chunk-AACZXOME.js";
import "./chunk-FGAS6YK6.js";
import "./chunk-NUMECXU6.js";
import "./chunk-2ZMIKOK6.js";
import "./chunk-C6WWHQR7.js";
import "./chunk-RSMEFNHU.js";
import "./chunk-TSZNKZMR.js";
import "./chunk-HJXLVLWH.js";
import {
  createSvgIcon
} from "./chunk-CFMNMUAO.js";
import "./chunk-MC76DRS7.js";
import "./chunk-G4DAYSRF.js";
import "./chunk-NSGKQ7NN.js";
import "./chunk-33WFEFMR.js";
import "./chunk-RYSDAAHV.js";
import "./chunk-EIIDING6.js";
import {
  useTheme
} from "./chunk-MAO7SSPN.js";
import {
  styled_default
} from "./chunk-GO7FYKZS.js";
import {
  require_prop_types
...
true ? AccountPreview.propTypes = {
  ...
  slots: import_prop_types.default.shape({
    ...
    avatarIconButton: import_prop_types.default.elementType,
    moreIconButton: import_prop_types.default.elementType
  }),
  /**
  ...
  return (0, import_jsx_runtime12.jsx)(List_default, {
    ...
    children: subNavigation.map((navigationItem, navigationItemIndex) => {
      ...
      if (navigationItem.kind === "divider") {
        ...
        return (0, import_jsx_runtime12.jsx)(Divider_default, {
          sx: {
            borderBottomWidth: 2,
            mx: 1,
            mt: 1,
      ...
      const nestedNavigationCollapseIcon = isNestedNavigationExpanded ? _ExpandLessIcon || (_ExpandLessIcon = (0, import_jsx_runtime12.jsx)(ExpandLess_default, {})) : _ExpandMoreIcon || (_ExpandMoreIcon = (0, import_jsx_runtime12.jsx)(ExpandMore_default, {}));
      ...
      const listItem = (0, import_jsx_runtime12.jsx)(ListItem_default, {
        sx: {
          py: 0,
          px: 1,
          overflowX: "hidden"
        ...
        children: (0, import_jsx_runtime12.jsxs)(NavigationListItemButton, {
          ...
          children: [navigationItem.icon || isMini ? (0, import_jsx_runtime12.jsxs)(ListItemIcon_default, {
            sx: {
              minWidth: listItemIconSize,
              mr: 1.2
            },
            children: [navigationItem.icon ?? null, !navigationItem.icon && isMini ? (0, import_jsx_runtime12.jsx)(Avatar_default, {
              sx: {
          ...
          }) : null, (0, import_jsx_runtime12.jsx)(ListItemText_default, {
      ...
      return (0, import_jsx_runtime12.jsxs)(React9.Fragment, {
        children: [isMini ? (0, import_jsx_runtime12.jsx)(Tooltip_default, {
          title: navigationItemTitle,
          placement: "right",
          children: listItem
        }) : listItem, navigationItem.children && !isMini ? (0, import_jsx_runtime12.jsx)(Collapse_default, {
  ...
  return isDualTheme ? (0, import_jsx_runtime15.jsx)(Tooltip_default, {
    ...
    children: (0, import_jsx_runtime15.jsx)("div", {
      children: (0, import_jsx_runtime15.jsx)(IconButton_default, {
        ...
        children: theme.getColorSchemeSelector ? (0, import_jsx_runtime15.jsxs)(React11.Fragment, {
        ...
        }) : (0, import_jsx_runtime15.jsx)(React11.Fragment, {
...
function ToolbarActions() {
  return _Stack || (_Stack = (0, import_jsx_runtime16.jsx)(Stack_default, {
    direction: "row",
    alignItems: "center",
    children: (0, import_jsx_runtime16.jsx)(ThemeSwitcher, {})
  }));
}
...
function ToolpadLogo({
  ...
  return (0, import_jsx_runtime17.jsxs)("svg", {
    ...
    children: [_g || (_g = (0, import_jsx_runtime17.jsxs)("g", {
      mask: "url(#a)",
    ...
    })), (0, import_jsx_runtime17.jsx)("mask", {
      id: "b",
      style: {
        maskType: "alpha"
      },
      ...
      width: "14",
      height: "15",
      children: _path || (_path = (0, import_jsx_runtime17.jsx)("path", {
    ...
    }), _g2 || (_g2 = (0, import_jsx_runtime17.jsxs)("g", {
      mask: "url(#b)",
      children: [(0, import_jsx_runtime17.jsx)("path", {
      ...
      width: "22",
      height: "20",
      children: _path2 || (_path2 = (0, import_jsx_runtime17.jsx)("path", {
    ...
    }), _g3 || (_g3 = (0, import_jsx_runtime17.jsxs)("g", {
      mask: "url(#c)",
      children: [(0, import_jsx_runtime17.jsx)("path", {
...
function DashboardLayout(props) {
  ...
  const theme = useTheme();
  const brandingContext = React14.useContext(BrandingContext);
  const navigationContext = React14.useContext(NavigationContext);
  const appWindowContext = React14.useContext(WindowContext);
  const applicationTitle = useApplicationTitle();
  const branding = brandingProp ?? brandingContext;
  const [isDesktopNavigationExpanded, setIsDesktopNavigationExpanded] = React14.useState(!defaultSidebarCollapsed);
  const [isMobileNavigationExpanded, setIsMobileNavigationExpanded] = React14.useState(false);
  ...
  const setIsNavigationExpanded = React14.useCallback((newExpanded) => {
  ...
  const [isNavigationFullyExpanded, setIsNavigationFullyExpanded] = React14.useState(isNavigationExpanded);
  React14.useEffect(() => {
  ...
  const selectedItemIdRef = React14.useRef("");
  const handleSetNavigationExpanded = React14.useCallback((newExpanded) => () => {
    setIsNavigationExpanded(newExpanded);
  }, [setIsNavigationExpanded]);
  const toggleNavigationExpanded = React14.useCallback(() => {
    setIsNavigationExpanded(!isNavigationExpanded);
  }, [isNavigationExpanded, setIsNavigationExpanded]);
  const handleNavigationLinkClick = React14.useCallback(() => {
  ...
  const getMenuIcon = React14.useCallback((isExpanded) => {
    const expandMenuActionText = "Expand";
    const collapseMenuActionText = "Collapse";
    return (0, import_jsx_runtime18.jsx)(Tooltip_default, {
      ...
      children: (0, import_jsx_runtime18.jsx)("div", {
        children: (0, import_jsx_runtime18.jsx)(IconButton_default, {
          ...
          children: isExpanded ? _MenuOpenIcon || (_MenuOpenIcon = (0, import_jsx_runtime18.jsx)(MenuOpen_default, {})) : _MenuIcon || (_MenuIcon = (0, import_jsx_runtime18.jsx)(Menu_default, {}))
        })
      })
    });
  ...
  const getDrawerContent = React14.useCallback((isMini, viewport) => {
    var _a;
    return (0, import_jsx_runtime18.jsxs)(React14.Fragment, {
      children: [_Toolbar || (_Toolbar = (0, import_jsx_runtime18.jsx)(Toolbar_default, {})), (0, import_jsx_runtime18.jsxs)(Box_default, {
        component: "nav",
        ...
        sx: {
          ...
          justifyContent: "space-between",
          overflow: "auto",
          pt: ((_a = navigationContext[0]) == null ? void 0 : _a.kind) === "header" && !isMini ? 0 : 2,
          ...hasDrawerTransitions ? getDrawerSxTransitionMixin(isNavigationFullyExpanded, "padding") : {}
        },
        children: [(0, import_jsx_runtime18.jsx)(DashboardSidebarSubNavigation, {
        ...
        }), SidebarFooterSlot ? (0, import_jsx_runtime18.jsx)(SidebarFooterSlot, {
          mini: isMini,
          ...slotProps == null ? void 0 : slotProps.sidebarFooter
        }) : null]
      })]
    });
  }, [SidebarFooterSlot, handleNavigationLinkClick, hasDrawerTransitions, isNavigationFullyExpanded, navigationContext, slotProps == null ? void 0 : slotProps.sidebarFooter]);
  const getDrawerSharedSx = React14.useCallback((isMini, isTemporary) => {
  ...
  const layoutRef = React14.useRef(null);
  return (0, import_jsx_runtime18.jsxs)(Box_default, {
    ref: layoutRef,
    sx: {
      position: "relative",
      display: "flex",
    ...
    children: [(0, import_jsx_runtime18.jsx)(AppBar, {
      color: "inherit",
      position: "absolute",
      sx: {
        displayPrint: "none"
      },
      children: (0, import_jsx_runtime18.jsx)(Toolbar_default, {
        sx: {
        ...
        children: (0, import_jsx_runtime18.jsxs)(Stack_default, {
          direction: "row",
          justifyContent: "space-between",
          alignItems: "center",
          sx: {
          ...
          children: [(0, import_jsx_runtime18.jsxs)(Stack_default, {
            direction: "row",
            children: [!hideNavigation ? (0, import_jsx_runtime18.jsxs)(React14.Fragment, {
              children: [(0, import_jsx_runtime18.jsx)(Box_default, {
                sx: {
                  mr: {
              ...
              }), (0, import_jsx_runtime18.jsx)(Box_default, {
                sx: {
                  display: {
                    xs: "none",
            ...
            }) : null, (0, import_jsx_runtime18.jsx)(Link, {
              href: "/",
              style: {
                color: "inherit",
                textDecoration: "none"
              ...
              children: (0, import_jsx_runtime18.jsxs)(Stack_default, {
                direction: "row",
                alignItems: "center",
                children: [(0, import_jsx_runtime18.jsx)(LogoContainer, {
                  children: (branding == null ? void 0 : branding.logo) ?? (_ToolpadLogo || (_ToolpadLogo = (0, import_jsx_runtime18.jsx)(ToolpadLogo, {
                    size: 40
                  })))
                }), (0, import_jsx_runtime18.jsx)(Typography_default, {
                  variant: "h6",
                  sx: {
          ...
          }), (0, import_jsx_runtime18.jsxs)(Stack_default, {
            direction: "row",
            alignItems: "center",
            spacing: 1,
            sx: {
            ...
            children: [(0, import_jsx_runtime18.jsx)(ToolbarActionsSlot, {
              ...slotProps == null ? void 0 : slotProps.toolbarActions
            }), (0, import_jsx_runtime18.jsx)(ToolbarAccountSlot, {
              ...slotProps == null ? void 0 : slotProps.toolbarAccount
            })]
          })]
        })
      })
    }), !hideNavigation ? (0, import_jsx_runtime18.jsxs)(React14.Fragment, {
      children: [(0, import_jsx_runtime18.jsx)(Drawer_default, {
      ...
      }), (0, import_jsx_runtime18.jsx)(Drawer_default, {
        variant: "permanent",
        sx: {
          display: {
            xs: "none",
    ...
    }) : null, (0, import_jsx_runtime18.jsxs)(Box_default, {
      sx: {
        display: "flex",
        flexDirection: "column",
        flex: 1,
