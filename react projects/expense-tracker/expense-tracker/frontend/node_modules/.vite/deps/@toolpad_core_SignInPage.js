...
var DocsContext = React21.createContext(false);
...
function SignInPage(props) {
  ...
  const branding = React22.useContext(BrandingContext);
  const docs = React22.useContext(DocsContext);
  const router = React22.useContext(RouterContext);
  ...
  const [{
    ...
    error,
    success
  }, setFormStatus] = React22.useState({
  ...
  const singleProvider = React22.useMemo(() => (providers == null ? void 0 : providers.length) === 1, [providers]);
  const isOauthProvider = React22.useCallback((provider) => provider && provider !== "credentials" && provider !== "nodemailer" && provider !== "passkey", []);
    ...
    children: (0, import_jsx_runtime23.jsx)(Container_default, {
      ...
      children: (0, import_jsx_runtime23.jsxs)(Box_default, {
        ...
        children: [branding == null ? void 0 : branding.logo, (slots == null ? void 0 : slots.title) ? (0, import_jsx_runtime23.jsx)(slots.title, {}) : (0, import_jsx_runtime23.jsxs)(Typography_default, {
          ...
          children: ["Sign in ", (branding == null ? void 0 : branding.title) ? `to ${branding.title}` : null]
        }), (slots == null ? void 0 : slots.subtitle) ? (0, import_jsx_runtime23.jsx)(slots.subtitle, {}) : _Typography || (_Typography = (0, import_jsx_runtime23.jsx)(Typography_default, {
          variant: "body2",
          color: "textSecondary",
          gutterBottom: true,
          textAlign: "center",
          ...
          children: [(0, import_jsx_runtime23.jsxs)(Stack_default, {
            ...
            children: [error && isOauthProvider(selectedProviderId) ? (0, import_jsx_runtime23.jsx)(Alert_default, {
              ...
              return (0, import_jsx_runtime23.jsx)("form", {
                onSubmit: async (event) => {
                  ...
                  setFormStatus((prev) => ({
                    ...prev,
                    loading: (oauthResponse == null ? void 0 : oauthResponse.error) || docs ? false : prev.loading,
                    error: oauthResponse == null ? void 0 : oauthResponse.error
                  }));
                },
                children: (0, import_jsx_runtime23.jsx)(LoadingButton_default, {
                  variant: "outlined",
                  type: "submit",
                  fullWidth: true,
                  size: "large",
          ...
          }), passkeyProvider ? (0, import_jsx_runtime23.jsxs)(React22.Fragment, {
            children: [singleProvider ? null : (0, import_jsx_runtime23.jsx)(Divider_default, {
              ...
              }) : (0, import_jsx_runtime23.jsxs)(LoadingButton_default, {
                type: "submit",
                fullWidth: true,
                size: "large",
                variant: "outlined",
          ...
          }) : null, emailProvider ? (0, import_jsx_runtime23.jsxs)(React22.Fragment, {
            children: [singleProvider ? null : (0, import_jsx_runtime23.jsx)(Divider_default, {
              sx: {
                mt: 2,
                mx: 0,
              ...
              children: [(slots == null ? void 0 : slots.emailField) ? (0, import_jsx_runtime23.jsx)(slots.emailField, {
                ...
                ...slotProps == null ? void 0 : slotProps.submitButton
              }) : (0, import_jsx_runtime23.jsx)(LoadingButton_default, {
                type: "submit",
                fullWidth: true,
                size: "large",
                variant: "outlined",
          ...
          }) : null, credentialsProvider ? (0, import_jsx_runtime23.jsxs)(React22.Fragment, {
            children: [singleProvider ? null : (0, import_jsx_runtime23.jsx)(Divider_default, {
              sx: {
                mt: 2,
                mx: 0,
              ...
              children: [(0, import_jsx_runtime23.jsxs)(Stack_default, {
                ...
                children: [(0, import_jsx_runtime23.jsx)(FormControlLabel_default, {
